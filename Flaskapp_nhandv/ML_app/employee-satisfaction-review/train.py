...
import glob, re, time, pickle, string, warnings
...
data_path = r"\data\fpt_reviews_simulation_data.csv"
...
pickle.dump(tfvect, open(r"..\models\viet_vect_fpt.pkl", 'wb'))
pickle.dump(multi_model, open(r"..\models\my_model.h5", 'wb'))
